...
@section('title', 'Editar Ficha de Admisión')
    ...
    <div class="row justify-content-center">
        <div class="col-md-6">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h2>EDITAR FICHA DE ADMISIÓN: {{ $fichas_admision->ficha }}</h2>
            ...
            <div class="card shadow">
                <div class="card-header bg-warning text-dark">
                    <h4 class="mb-0">Editar Ficha de Admisión</h4>
                </div>
                <div class="card-body">
                    ...
                    <!-- Formulario -->
                    <form action="{{ route('fichas_admision.update', $fichas_admision->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <input 
                                    ...
                                    id="periodo" 
                                    name="periodo" 
                                    value="{{ old('periodo', $fichas_admision->periodo) }}"
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <input 
                                    ...
                                    value="{{ old('folio_solicitud', $fichas_admision->folio_solicitud) }}"
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <input 
                                    ...
                                    id="carrera" 
                                    name="carrera" 
                                    value="{{ old('carrera', $fichas_admision->carrera) }}"
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <input 
                                    ...
                                    id="reticula" 
                                    name="reticula" 
                                    value="{{ old('reticula', $fichas_admision->reticula) }}"
                                    placeholder="Ej: 210">
                                @error('reticula')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <input 
                                    ...
                                    id="ficha" 
                                    name="ficha" 
                                    value="{{ old('ficha', $fichas_admision->ficha) }}"
                                    placeholder="Ej: 33"
                                    required>
                                @error('ficha')
                                    <div class="invalid-feedback">{{ $message }}</div>
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <input 
                                    ...
                                    id="curp" 
                                    name="curp" 
                                    value="{{ old('curp', $fichas_admision->curp) }}"
                                    placeholder="Ej: VESV650205MGRLNA3"
                                    maxlength="18">
                                @error('curp')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <input 
                                    ...
                                    value="{{ old('apellidos_aspirante', $fichas_admision->apellidos_aspirante) }}"
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <input 
                                    ...
                                    value="{{ old('nombre_aspirante', $fichas_admision->nombre_aspirante) }}"
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <input 
                                    ...
                                    value="{{ old('fecha_nacimiento', $fichas_admision->fecha_nacimiento?->format('Y-m-d')) }}">
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <select 
                                    ...
                                    <option value="M" {{ old('sexo', $fichas_admision->sexo) == 'M' ? 'selected' : '' }}>Masculino</option>
                                    <option value="F" {{ old('sexo', $fichas_admision->sexo) == 'F' ? 'selected' : '' }}>Femenino</option>
                                </select>
                                @error('sexo')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <select 
                                    ...
                                    name="estado_civil">
                                    <option value="">Seleccione...</option>
                                    <option value="S" {{ old('estado_civil', $fichas_admision->estado_civil) == 'S' ? 'selected' : '' }}>Soltero/a</option>
                                    <option value="C" {{ old('estado_civil', $fichas_admision->estado_civil) == 'C' ? 'selected' : '' }}>Casado/a</option>
                                    <option value="D" {{ old('estado_civil', $fichas_admision->estado_civil) == 'D' ? 'selected' : '' }}>Divorciado/a</option>
                                    <option value="V" {{ old('estado_civil', $fichas_admision->estado_civil) == 'V' ? 'selected' : '' }}>Viudo/a</option>
                                </select>
                                @error('estado_civil')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <input 
                                    ...
                                    id="tipo_escuela" 
                                    name="tipo_escuela" 
                                    value="{{ old('tipo_escuela', $fichas_admision->tipo_escuela) }}"
                                    placeholder="Ej: 1">
                                @error('tipo_escuela')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <input 
                                    ...
                                    id="clave_escuela" 
                                    name="clave_escuela" 
                                    value="{{ old('clave_escuela', $fichas_admision->clave_escuela) }}"
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <input 
                                    ...
                                    value="{{ old('escuela_procedencia', $fichas_admision->escuela_procedencia) }}"
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <input 
                                    ...
                                    value="{{ old('promedio_bachillerato', $fichas_admision->promedio_bachillerato) }}"
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <input 
                                    ...
                                    value="{{ old('anio_termino_bachillerato', $fichas_admision->anio_termino_bachillerato) }}"
                                    placeholder="Ej: 2023">
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <input 
                                    ...
                                    value="{{ old('entidad_federativa_proc', $fichas_admision->entidad_federativa_proc) }}"
                        ...
                        <div class="d-grid gap-2 d-md-flex justify-content-md-end mt-4">
                            ...
                            <button type="submit" class="btn btn-warning">
                                <i class="bi bi-save"></i> Actualizar Ficha De Admisión
                            </button>
                        </div>
                    </form>
